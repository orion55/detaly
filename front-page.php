	...
	<div class="container">
		<div class="row production">
			...
			<div class="col-lg-4 col-12">
				<ul uk-switcher="connect: .production_box; swiping: false;  animation: uk-animation-fade" class="production_thumbnav">
					<?php if ($production_1): ?>
...
<section id="partners" class="partners_section">
	...
	<div class="container">
		...
		<div class="row pre_partners">
			<div class="col-md-9">
				<ul class="pre_partners_list" uk-switcher="connect: .partners_switcher; toggle: .pre_part_item; swiping: false; animation: uk-animation-fade">
					<div class="span_box">
		...
		<div class="row partners">
			...
			<div class="col-lg-4 col-12">
				<div class='partners_thumbs_viewport'>
					...
					<ul class="partners_thumbs partners_thumbs2" uk-switcher="connect: .partners_switcher; toggle: > .partners_thumbnav_item; swiping: false; animation: uk-animation-fade">
					<?php foreach($partners_row as $row): ?>
					<?php $company = $row['company']; ?>
...
<section id="our_works" class="our_works_section">
	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="pre_work" uk-switcher="connect: .works_list; toggle: .pre_learn_more; swiping: false; animation: uk-animation-fade">
			...
			<div class="row work_more">
				...
				<div class="col-lg-12">
					<div class="work_switch_viewport">
						<ul class="work_switcher" uk-switcher="connect: .works_list; toggle: > .work_thumb; swiping: false; animation: uk-animation-fade">
							<?php foreach($ourworks_row as $row): ?>
							<?php $project = $row['project'];?>
							<li class="work_thumb">
